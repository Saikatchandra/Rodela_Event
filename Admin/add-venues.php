...
if(isset($_POST['save_venue'])){
 ...
 $image = date('Ymdhis.').$image_ext;
  ...
  $result = mysqli_query($con, "INSERT INTO `venue`(`venue_Id`, `venue_name`, `venue_address`, `prefered_for`, `venue_price`, `image`, `description`, `status`) VALUES ('$venue_Id', '$venue_name', '$venue_address', '$prefered_for', '$venue_price', '$image', '$description', '0')");
	    ...
	    <div class="col-md-8 col-md-offset-2">
         ...
         <?php
            ...
            <div class="form-group has-error">
    		        ...
    		        <input type="text" class="form-control" name="venue-price" placeholder="Enter venue price" value="<?= isset($venue_price) ? $venue_price: '' ?>"/>
    		    </div>
             <div class="form-group">
